...
// checks if the ListCountriesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListCountriesResponse{}
...
func (o ListCountriesResponse) ToMap() (map[string]interface{}, error) {
