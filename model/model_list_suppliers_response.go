...
// checks if the ListSuppliersResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListSuppliersResponse{}
...
func (o ListSuppliersResponse) ToMap() (map[string]interface{}, error) {
