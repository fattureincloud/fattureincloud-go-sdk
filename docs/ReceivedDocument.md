...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **NullableInt32** | Received document id | [optional] 
...
**Date** | Pointer to **NullableString** | Received document date [defaults to today&#39;s date] | [optional] 
**Category** | Pointer to **NullableString** | Received document category | [optional] 
**Description** | Pointer to **NullableString** | Received document description | [optional] 
...
**AmountGross** | Pointer to **NullableFloat32** | [Read Only] Received document total gross amount | [optional] [readonly] 
**Amortization** | Pointer to **NullableFloat32** | Received document amortization value | [optional] 
**RcCenter** | Pointer to **NullableString** | Received document revenue center | [optional] 
**InvoiceNumber** | Pointer to **NullableString** | Received document invoice number | [optional] 
**IsMarked** | Pointer to **NullableBool** | Received document is marked | [optional] 
**IsDetailed** | Pointer to **NullableBool** | Received document has items | [optional] 
**EInvoice** | Pointer to **NullableBool** | [Read Only] Received document is an e-invoice | [optional] 
**NextDueDate** | Pointer to **NullableString** | [Read Only] Received document date of the next not paid payment | [optional] [readonly] 
**Currency** | Pointer to [**Currency**](Currency.md) |  | [optional] 
**TaxDeductibility** | Pointer to **NullableFloat32** | Received document tax deducibility percentage | [optional] 
**VatDeductibility** | Pointer to **NullableFloat32** | Received document vat deducibility percentage | [optional] 
...
**AttachmentUrl** | Pointer to **NullableString** | [Temporary] [Read Only] Received document url of the attached file | [optional] [readonly] 
