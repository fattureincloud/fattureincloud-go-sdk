...
**Qty** | Pointer to **NullableFloat32** | Items quantity, | [optional] 
**Measure** | Pointer to **NullableString** | Item measure. | [optional] 
**NetPrice** | Pointer to **NullableFloat32** | Net price. | [optional] 
**GrossPrice** | Pointer to **NullableFloat32** | Gross price. | [optional] 
**Vat** | Pointer to [**NullableVatType**](VatType.md) |  | [optional] 
**NotTaxable** | Pointer to **NullableBool** |  | [optional] 
