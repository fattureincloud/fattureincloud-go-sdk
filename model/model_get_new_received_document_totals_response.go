...
// checks if the GetNewReceivedDocumentTotalsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNewReceivedDocumentTotalsResponse{}
...
func (o GetNewReceivedDocumentTotalsResponse) ToMap() (map[string]interface{}, error) {
