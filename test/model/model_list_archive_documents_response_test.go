...
var ListArchiveDocumentsResponseJsonStr string = "{\"current_page\":10,\"first_page_url\":\"https://www.page.url/\",\"from\":10,\"last_page\":10,\"last_page_url\":\"https://www.page.url/\",\"next_page_url\":\"https://www.page.url/\",\"path\":\"https://www.page.url/\",\"per_page\":10,\"prev_page_url\":\"https://www.page.url/\",\"to\":10,\"total\":10,\"data\":[{\"id\":12345,\"date\":\"2021-08-20\",\"description\":\"spesa 2\",\"category\":\"Altri documenti\",\"attachment_token\":\"jwfbaiuwbfoiewfoa8weohafw7gefa9we\"}]}"

func TestListArchiveDocumentsResponse(t *testing.T) {
	obj := NewListArchiveDocumentsResponse()
	json.Unmarshal([]byte(ListArchiveDocumentsResponseJsonStr), obj)
	jsonStr2, _ := json.Marshal(obj)

	assert.JSONEq(t, ListArchiveDocumentsResponseJsonStr, string(jsonStr2), "they should be equal")

	newObj := NewListArchiveDocumentsResponse()
