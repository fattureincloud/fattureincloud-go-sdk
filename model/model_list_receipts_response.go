...
// checks if the ListReceiptsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListReceiptsResponse{}
...
func (o ListReceiptsResponse) ToMap() (map[string]interface{}, error) {
