...
var Scopes = struct { 
    ...
    ISSUED_DOCUMENTS_WORK_REPORTS_READ Scope
    ISSUED_DOCUMENTS_SUPPLIER_ORDERS_READ Scope
    ISSUED_DOCUMENTS_SELF_INVOICES_READ Scope
    ...
    ISSUED_DOCUMENTS_WORK_REPORTS_ALL Scope
    ISSUED_DOCUMENTS_SUPPLIER_ORDERS_ALL Scope
    ISSUED_DOCUMENTS_SELF_INVOICES_ALL Scope
