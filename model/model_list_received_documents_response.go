...
// checks if the ListReceivedDocumentsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListReceivedDocumentsResponse{}
...
func (o ListReceivedDocumentsResponse) ToMap() (map[string]interface{}, error) {
