...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **NullableInt32** | Archive document id | [optional] 
...
**AttachmentUrl** | Pointer to **NullableString** | [Temporary] [Read Only] Archive Document url of the attached file | [optional] [readonly] 
**Category** | Pointer to **NullableString** | Archive document category | [optional] 
**AttachmentToken** | Pointer to **NullableString** | [Write Only]  [Required] Archive document attachment token returned by POST /archive/attachment | [optional] 
