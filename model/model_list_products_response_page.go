...
// checks if the ListProductsResponsePage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListProductsResponsePage{}
...
func (o ListProductsResponsePage) ToMap() (map[string]interface{}, error) {
