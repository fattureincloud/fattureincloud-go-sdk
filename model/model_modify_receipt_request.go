...
// checks if the ModifyReceiptRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifyReceiptRequest{}
...
func (o ModifyReceiptRequest) ToMap() (map[string]interface{}, error) {
