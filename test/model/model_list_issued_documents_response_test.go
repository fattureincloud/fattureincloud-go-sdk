...
var ListIssuedDocumentsResponseJsonStr string = "{\"current_page\":10,\"first_page_url\":\"https://www.page.url/\",\"from\":10,\"last_page\":10,\"last_page_url\":\"https://www.page.url/\",\"next_page_url\":\"https://www.page.url/\",\"path\":\"https://www.page.url/\",\"per_page\":10,\"prev_page_url\":\"https://www.page.url/\",\"to\":10,\"total\":10,\"data\":[{\"id\":12345,\"type\":\"invoice\",\"notes\":\"bando\",\"show_totals\":\"all\"}]}"

func TestListIssuedDocumentsResponse(t *testing.T) {
	obj := NewListIssuedDocumentsResponse()
	json.Unmarshal([]byte(ListIssuedDocumentsResponseJsonStr), obj)
	jsonStr2, _ := json.Marshal(obj)

	assert.JSONEq(t, ListIssuedDocumentsResponseJsonStr, string(jsonStr2), "they should be equal")

	newObj := NewListIssuedDocumentsResponse()
