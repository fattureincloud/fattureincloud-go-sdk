...
// checks if the ListUnitsOfMeasureResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListUnitsOfMeasureResponse{}
...
func (o ListUnitsOfMeasureResponse) ToMap() (map[string]interface{}, error) {
