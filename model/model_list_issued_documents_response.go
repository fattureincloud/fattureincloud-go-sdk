...
// checks if the ListIssuedDocumentsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListIssuedDocumentsResponse{}
...
func NewListIssuedDocumentsResponse() *ListIssuedDocumentsResponse {
	this := ListIssuedDocumentsResponse{}
	return &this
}
...
func (o ListIssuedDocumentsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableListIssuedDocumentsResponse struct {
	value *ListIssuedDocumentsResponse
	isSet bool
}

func (v NullableListIssuedDocumentsResponse) Get() *ListIssuedDocumentsResponse {
	return v.value
}

func (v *NullableListIssuedDocumentsResponse) Set(val *ListIssuedDocumentsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListIssuedDocumentsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListIssuedDocumentsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListIssuedDocumentsResponse(val *ListIssuedDocumentsResponse) *NullableListIssuedDocumentsResponse {
	return &NullableListIssuedDocumentsResponse{value: val, isSet: true}
}

func (v NullableListIssuedDocumentsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListIssuedDocumentsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
